...
if [ "$START_PIMCORE_MESSENGER_CONSUME" = "YES" ]; then
    touch /etc/s6-overlay/s6-rc.d/user/contents.d/pimcore-messenger-consume-async
    ...
    touch /etc/s6-overlay/s6-rc.d/user/contents.d/pimcore-messenger-consume-image_optimize3
    touch /etc/s6-overlay/s6-rc.d/user/contents.d/pimcore-messenger-consume-image_optimize4
    touch /etc/s6-overlay/s6-rc.d/user/contents.d/pimcore-messenger-consume-maintenance
    touch /etc/s6-overlay/s6-rc.d/user/contents.d/pimcore-messenger-consume-scheduled_tasks
fi
